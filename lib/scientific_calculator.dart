...
class ScientificCalculator extends StatefulWidget {
  ...
  const ScientificCalculator({super.key, required this.isDarkMode});
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        int columns = 5;
        if (maxWidth > 800) columns = 6;
        if (maxWidth > 1200) columns = 7;
      ...
      children: [
        ...
        CalculatorButton(
          label: 'π',
          color: Colors.teal,
          onPressed: () => onButtonPressed('3.14159'),
          isDarkMode: isDarkMode,
        ),
        CalculatorButton(
          label: '4',
        ...
        CalculatorButton(
          label: 'e',
          color: Colors.teal,
          onPressed: () => onButtonPressed('2.71828'),
          isDarkMode: isDarkMode,
        ),
        CalculatorButton(
          label: '1',
